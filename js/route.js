      ...
      turns: [
        { s: '運転手さんが目的地を尋ねてきた。',
          ...
          choices: [
            ...
            { card: 'ko5-5', d: -1, why: '「後でメールを送ってもいいですか?」— 運転手さんと連絡先を交換しても、ホテルには着きません。' }
          ] },
      ...
      turns: [
        { s: 'Kim教授と目が合った。歩み寄って、最初のひとこと。',
          ...
          choices: [
            ...
            { card: 'ko4-6', d: -1, why: '「韓国料理は本当においしいです」— まだ何も食べていません。食事の話は懇親会にとっておきましょう。' }
          ] },
        { s: '教授が笑顔で握手を求めてきた。',
      ...
      turns: [
        ...
        { s: '完食。会計を終えて、ごちそうしてくれたKim教授にひとこと。',
          ...
          choices: [
            ...
            { card: 'ko6-1', d: -1, why: '「もう一度おっしゃってください」— 誰も何も言っていません。食べ終えた合図は「잘 먹었습니다」です。' }
          ] }
      ]
    }
  },
      ...
      turns: [
        ...
        { s: '隣の教授がボトルを傾けてお酒を注ごうとしてくれる。実はあまり飲めない…',
          ...
          choices: [
            ...
            { card: 'ko5-4', d: -1, why: '「私もその分野に興味があります」— 話をそらしても、グラスは目の前のままです。飲めないことは正直に伝えるのが親切。' },
      ...
      turns: [
        ...
        { s: '議論が盛り上がった。このつながりを次に残したい。',
          ...
          choices: [
            ...
            { card: 'ko5-4', d: 0, why: '「私もその分野に興味があります」— 共感で終わってしまいました。もうひと押しで次の約束が作れたのに。' }
          ] }
      ]
    }
  },
      ...
      turns: [
        { s: '教授が「楽しかったですね」と笑っている。まず伝えるべきは…',
          ...
          choices: [
            ...
            { card: 'ko5-6', d: 0, why: '「一緒に写真を撮ってもいいですか?」— 良い場面もありますが、まずお礼を伝えてからにしましょう。' },
      ...
      turns: [
        ...
        { s: 'お義父さんが何か尋ねてきた。早口でまったく聞き取れない…!',
          ...
          choices: [
            ...
            { card: 'yue5-1', d: -1, why: '「私たちの結婚式に来てくださってありがとうございます」— 顔合わせの席では気が早すぎます。今日はまず自己紹介から。' }
          ] }
      ]
    }
  },
      ...
      turns: [
        { s: '玄関を入った。まず伝えたいのは…',
          ...
          choices: [
            ...
            { card: 'yue4-4', d: 2, why: '「Uncle / Auntie」と呼びかけるのも香港では自然で気楽な入り方です。' },
        ...
        { s: '手料理が並ぶ食卓。「たくさん食べてね」とお義母さん。食事が進んだところで、ひとこと。',
          ...
          choices: [
            ...
            { card: 'yue3-6', d: -1, why: '「すみません、お茶をください」— 家族の食卓でお店のように注文してしまいました。今は気持ちを伝える場面です。' }
          ] },
    ...
    boss: {
      ...
      turns: [
        { s: '屋台のおばちゃんが、ものすごい早口で話しかけてきた!',
          ...
          choices: [
            { card: 'yue6-3', d: 3, best: true, why: '「唔該,講慢啲吖」— 唔該を先に、最後に吖を添えた柔らかい減速リクエスト。監修で学んだ形がそのまま実戦で使えます。' },
            { card: 'yue6-2', d: 2, why: '「もう一度言ってください」— こちらも立派な切り抜けです。' },
            { card: 'yue6-5', d: 1, why: '「あまりよく分かりません」— 正直ですが、次につながる一言があるとより良いです。' },
            { card: 'yue3-7', d: -1, why: '「これは何ですか?」— 聞き取れなかったのは品物ではなく言葉のほうです。速さの調整をお願いしましょう。' }
          ] },
      ...
      turns: [
        ...
        { s: 'ご両親の前へ。お義母さんの目が潤んでいる。育ててくれたことへの感謝を。',
          ...
          choices: [
            ...
            { card: 'yue5-1', d: -1, why: '「結婚式に来てくださってありがとう」— これはゲスト全員への言葉。今はご両親お二人に向けた感謝を伝える場面です。' }
          ] },
        { s: '最後に、ご両親の目を見て、誓いの言葉を。',
          ...
          choices: [
            ...
            { card: 'yue6-4', d: 1, why: '「広東語は少しだけ分かります」— 謙遜も素敵ですが、今日はただ一つ、誓いの言葉を。' },
...
/* 路線の定義 */
/* ================= Seoul Route(パートナーコース) =================
 * 学会には出ず、懇親会・ディナーと日中のソウル観光で過ごす人の1週間。
 * 到着 → ひとりで街へ → 思わぬ足止め → 懇親会 → 送別ディナー という流れで、
 * kp1〜kp6 のユニットを一度ずつ本番として使う。 */
const SEOUL_ROUTE = [
  {
    id: 'sl-arrival', icon: '✈️', title: '仁川に着く',
    desc: '空港からホテルまで。まずは移動を自分の力で',
    units: ['kp4'],
    boss: {
      title: 'タクシーでホテルへ', partner: 'タクシーの運転手さん',
      intro: '入国審査を抜け、外に出ると11月のソウルの空気は思ったより冷たい。タクシー乗り場に並び、順番が来た。運転手さんがトランクを開けながらこちらを見ている。',
      turns: [
        { s: '荷物を積み終えた運転手さんが、ミラー越しに行き先を尋ねてきた。ホテル名の発音に自信がない。',
          line: { t: '어디로 모실까요?', ja: 'どちらへお連れしましょうか?' },
          choices: [
            { card: 'kp4-2', d: 3, best: true, why: '「여기로 가 주세요」— 予約画面を見せながらこれだけで完璧です。発音に自信がなくても確実に伝わる、いちばん賢いやり方。' },
            { card: 'kp4-1', d: 0, why: '「この近くに地下鉄の駅はありますか?」— せっかくタクシーに乗ったのに、駅を探し始めてしまいました。' },
            { card: 'kp4-5', d: 0, why: '「歩いて行けますか?」— 空港からホテルまでは歩けません。運転手さんが困っています。' },
            { card: 'kp4-8', d: -1, why: '「何時までやっていますか?」— タクシーは24時間走っています。話が噛み合いません。' }
          ] },
        { s: '高速に乗ってしばらく。渋滞が始まった。ホテルのチェックイン時間が気になる。',
          line: { t: '오늘 길이 좀 막히네요.', ja: '今日はちょっと道が混んでいますね。' },
          choices: [
            { card: 'kp4-3', d: 3, best: true, why: '「얼마나 걸려요?」— まさにこれ。時間を聞けば、チェックインに間に合うか判断できます。' },
            { card: 'kp4-1', d: 1, why: '「この近くに地下鉄の駅はありますか?」— 渋滞なら地下鉄という手も。ただ、大きな荷物を持って乗り換えるのは大変です。' },
            { card: 'kp4-6', d: -1, why: '「道に迷いました」— 迷っているのは運転手さんではありません。不安にさせてしまいます。' },
            { card: 'kp4-4', d: -1, why: '「乗り換えはどこでしますか?」— タクシーに乗り換えはありません。' }
          ] },
        { s: 'ホテルの前の道が工事中で、車が入れない。運転手さんが手前の角を指さしている。',
          line: { t: '앞에 공사 중이라 여기까지만 갈 수 있어요.', ja: '前が工事中で、ここまでしか行けません。' },
          choices: [
            { card: 'kp4-5', d: 3, best: true, why: '「걸어서 갈 수 있어요?」— 歩ける距離か確かめる一言。**-(으)ㄹ 수 있어요?** は旅行中いちばん出番の多い型です。' },
            { card: 'kp4-3', d: 2, why: '「どのくらいかかりますか?」— 悪くありません。歩く時間を聞いたことになります。' },
            { card: 'kp4-6', d: 1, why: '「道に迷いました」— まだ迷ってはいません。少し気が早い一言です。' },
            { card: 'kp4-7', d: -1, why: '「写真を撮っていただけますか?」— 工事現場の前で記念撮影。運転手さんが戸惑っています。' }
          ] }
      ]
    }
  },
  {
    id: 'sl-myeongdong', icon: '🛍️', title: 'ひとりで街へ',
    desc: '明洞の店とカフェ。声をかけられても大丈夫',
    units: ['kp5'],
    boss: {
      title: '明洞のセレクトショップ', partner: '店員さん',
      intro: '日中は自由時間。明洞のにぎやかな通りで、感じのいい店を見つけて入ってみた。ドアが閉まると同時に、店員さんが笑顔で近づいてくる。',
      turns: [
        { s: '入ってすぐ、店員さんに声をかけられた。まだ何も見ていない。',
          line: { t: '뭐 찾으세요?', ja: '何をお探しですか?' },
          choices: [
            { card: 'kp5-1', d: 3, best: true, why: '「그냥 볼게요」— これを知っているかどうかで、買い物の気楽さがまるで変わります。店員さんもすっと引いてくれます。' },
            { card: 'kp5-4', d: 1, why: '「これはいくらですか?」— 通じますが、何も手に取っていないので店員さんが「どれですか?」と困ります。' },
            { card: 'kp5-3', d: 0, why: '「もっと大きいサイズはありますか?」— まだ何も手に取っていません。店員さんが「何のサイズですか?」と困ってしまいます。' },
            { card: 'kp5-8', d: -1, why: '「持ち帰りでお願いします」— 服屋さんで包んでもらう前に、まず選びましょう。' }
          ] },
        { s: 'ひととおり見て、厚手のコートが気に入った。鏡の前で当ててみたが、着てみないと分からない。',
          line: { t: '그거 이번에 새로 들어온 거예요.', ja: 'それ、今回新しく入ったものなんですよ。' },
          choices: [
            { card: 'kp5-2', d: 3, best: true, why: '「입어 봐도 돼요?」— 試着の一言。**-아/어도 돼요?**(〜してもいいですか)は、許可を求めるときの万能の型です。' },
            { card: 'kp5-4', d: 2, why: '「いくらですか?」— 先に値段を聞くのも現実的です。ただ、気に入ったなら着てみるのが先。' },
            { card: 'kp5-3', d: 1, why: '「もっと大きいサイズはありますか?」— まだ着ていないので、サイズの話は少し早いです。' },
            { card: 'kp5-5', d: 0, why: '「少しまけてください」— まだ着てもいないうちから値切り交渉。しかも明洞の路面店は定価販売がふつうです。' },
          ] },
        { s: '試着したらぴったり。買うことにしてレジへ。財布には少ししか現金がない。',
          line: { t: '결제 도와드릴게요.', ja: 'お会計しますね。' },
          choices: [
            { card: 'kp5-6', d: 3, best: true, why: '「카드로 계산할게요」— 韓国はカードがほぼどこでも使えます。現金を数える必要がありません。' },
            { card: 'kp5-5', d: 0, why: '「少しまけてください」— 明洞の路面店では定価販売がふつう。値切るのは市場での作法です。' },
            { card: 'kp5-1', d: -1, why: '「見ているだけです」— レジまで来て「見ているだけ」。店員さんの手が止まってしまいました。' },
            { card: 'kp4-8', d: -1, why: '「何時までやっていますか?」— 閉店時間を聞くより、まず支払いを済ませましょう。' }
          ] }
      ]
    }
  },
  {
    id: 'sl-trouble', icon: '🆘', title: '思わぬ足止め',
    desc: '歩きすぎた午後。困ったときの言葉を使う',
    units: ['kp6'],
    boss: {
      title: '路地裏の薬局', partner: '薬剤師さん',
      intro: '午後いっぱい歩き回ったせいか、こめかみが痛みだした。今夜は懇親会がある。近くの人に助けを求めることにした。',
      turns: [
        { s: '通りがかりの女性に声をかけた。まず、薬を買える場所を知りたい。',
          line: { t: '네, 무슨 일이세요?', ja: 'はい、どうされました?' },
          choices: [
            { card: 'kp6-3', d: 3, best: true, why: '「약국이 어디에 있어요?」— 目的をはっきり伝えられました。「~이/가 어디에 있어요?」は場所を尋ねる基本の型です。' },
            { card: 'kp6-2', d: 2, why: '「体調が少し悪いです」— 状況は伝わります。この後に「薬局はどこですか?」を続ければ完璧でした。' },
            { card: 'kp6-1', d: 1, why: '「助けてください」— 間違いではありませんが、何に困っているかが分からず相手が身構えます。' },
            { card: 'kp6-6', d: -1, why: '「カバンをなくしました」— なくしてはいません。話がややこしくなりました。' }
          ] },
        { s: '緑の十字の看板を見つけた。薬局に入ると、白衣の薬剤師さんがカウンターの向こうから顔を上げた。',
          line: { t: '어서 오세요. 어디가 안 좋으세요?', ja: 'いらっしゃいませ。どこが悪いんですか?' },
          choices: [
            { card: 'kp6-4', d: 3, best: true, why: '「두통약 있어요?」— ほしいものをそのまま。**~약** で薬の種類を言えます(감기약=風邪薬、소화제=消化剤)。' },
            { card: 'kp6-2', d: 2, why: '「体調が少し悪いです」— 症状を伝える良い入り方。ただ、頭痛と言えたほうが早く済みます。' },
            { card: 'kp6-8', d: 1, why: '「病院に行きたいです」— 頭痛で病院はやや大げさ。まず薬局で相談するのが現実的です。' },
            { card: 'kp6-7', d: 0, why: '「日本語ができる方はいらっしゃいますか?」— 保険ではありますが、せっかく言えるフレーズを持っています。' }
          ] },
        { s: '薬を買って外に出た。似たような路地ばかりで、来た道が分からなくなった。ホテルの名前は覚えている。',
          line: { t: '(見覚えのない交差点)', ja: '(ここはどこだろう…)' },
          choices: [
            { card: 'kp4-6', d: 3, best: true, why: '「길을 잃었어요」— 助けを求める入口。この後に「◯◯이/가 어디예요?」を続ければ、たいてい案内してもらえます。' },
            { card: 'kp6-1', d: 2, why: '「助けてください」— 通じます。ただ「道に迷いました」のほうが、何を助けてほしいかが一目で伝わります。' },
            { card: 'kp4-1', d: 2, why: '「この近くに地下鉄の駅はありますか?」— 駅まで出れば戻れます。実用的な一手。' },
            { card: 'kp6-5', d: -1, why: '「アレルギーがあります」— 道に迷った話とつながりません。相手が薬局へ連れ戻してしまいます。' }
          ] }
      ]
    }
  },
  {
    id: 'sl-reception', icon: '🥂', title: '懇親会',
    desc: '初対面の輪に入る。今夜が本番',
    units: ['kp1', 'kp2'],
    boss: {
      title: 'レセプション会場', partner: '韓国の研究者',
      intro: 'ホテルの宴会場。同行者は主催者に呼ばれていってしまい、ひとりグラスを持って立っている。隣に立っていた人が、こちらに体を向けて微笑んだ。',
      turns: [
        { s: '相手が軽く会釈して、話しかけてきた。ここが第一声。',
          line: { t: '안녕하세요. 저는 김민준이라고 합니다.', ja: 'こんにちは。キム・ミンジュンと申します。' },
          choices: [
            { card: 'kp2-1', d: 3, best: true, why: '「처음 뵙겠습니다」— 初対面のいちばん丁寧な挨拶。「뵙다」は「会う」の謙譲語で、自分を低める言い方です。' },
            { card: 'kp2-3', d: 1, why: '「お名前は何とおっしゃいますか?」— たった今名乗ってくれたところです。聞いていなかったことになってしまいます。' },
            { card: 'kp1-1', d: 0, why: '「あ、そうなんですか?」— 相づちとしては使えますが、名乗られたら挨拶を返すのが先です。' },
            { card: 'kp2-8', d: -1, why: '「今日は本当に楽しかったです」— まだ始まったばかり。もう帰るのかと思われます。' }
          ] },
        { s: '少し話したあと、相手が不思議そうに尋ねてきた。学会のプログラムに自分の名前はない。',
          line: { t: '어느 세션에서 발표하세요?', ja: 'どのセッションで発表されるんですか?' },
          choices: [
            { card: 'kp2-2', d: 3, best: true, why: '「일행이 이 학회에서 발표해요」— 自分の立場を一言で。「일행(同行者)」は角が立たない便利な語です。' },
            { card: 'kp2-5', d: 2, why: '「韓国は今回が初めてです」— 質問の答えにはなっていませんが、話題は転がります。会話としては悪くない一手。' },
            { card: 'kp1-3', d: 0, why: '「そうですね」— 何に同意したのか分からず、発表することになってしまいました。' },
            { card: 'kp1-6', d: 1, why: '「もう一度おっしゃっていただけますか?」— 聞き返しは誠実ですが、二度目も同じ質問が返ってきます。' }
          ] },
        { s: 'ひとしきり話して、会話が途切れた。沈黙が少し長い。グラスの氷が鳴った。',
          line: { t: '…', ja: '(何か言わないと…)' },
          choices: [
            { card: 'kp2-7', d: 3, best: true, why: '「분위기가 참 좋네요」— その場のことを言えば沈黙は埋まります。**-네요** は、いま感じたことを述べる語尾。会場・料理・景色、何にでも使えます。' },
            { card: 'kp1-5', d: 2, why: '「どう思われますか?」— 相手に振るのは良い手ですが、何について聞いているかが宙に浮きます。' },
            { card: 'kp2-6', d: 1, why: '「お噂はかねがね」— 初対面で、しかも沈黙のあとに出すには唐突です。' },
            { card: 'kp1-7', d: -1, why: '「少しだけゆっくりお願いします」— 相手は何も話していません。沈黙をゆっくりにはできません。' }
          ] }
      ]
    }
  },
  {
    id: 'sl-dinner', icon: '🍶', title: '送別ディナー',
    desc: '最後の夜。注ぎ合いも、断り方も',
    units: ['kp3'],
    boss: {
      title: '明洞の焼肉店', partner: 'ホストの先生',
      intro: '滞在最終日の夜。同行者の共同研究者が、ふたりを食事に誘ってくれた。座敷に案内され、緑の瓶が運ばれてくる。ホストの先生は目上の方だ。',
      turns: [
        { s: '先生のグラスが空になっているのに気づいた。韓国では、自分では注がない。',
          line: { t: '자, 오늘은 편하게 드세요.', ja: 'さあ、今日は気楽に召し上がってください。' },
          choices: [
            { card: 'kp3-1', d: 3, best: true, why: '「제가 따라 드릴게요」— 気づいて注げるかどうかが、韓国の席では大きな差になります。**両手で瓶を持つ**のを忘れずに。' },
            { card: 'kp3-2', d: 2, why: '「一杯どうぞ」— 勧める言葉としては自然です。ただ、空いているのは先生のグラス。注ぐ側に回りましょう。' },
            { card: 'kp3-6', d: 0, why: '「もうやめておきます」— まだ一杯も飲んでいません。先生が心配してしまいます。' },
            { card: 'kp3-7', d: -1, why: '「私が払います」— 始まってすぐ会計の話。先生の顔が曇りました。' }
          ] },
        { s: '真っ赤なスープの鍋が運ばれてきた。先生が取り分けようとしている。辛いものは得意ではない。',
          line: { t: '이거 진짜 맛있어요. 좀 드셔 보세요.', ja: 'これ本当においしいんですよ。少し召し上がってみてください。' },
          choices: [
            { card: 'kp3-4', d: 3, best: true, why: '「매운 음식은 잘 못 먹어요」— **잘 못 -** は「あまり〜できない」。「싫어요(嫌いです)」より、ずっと角が立ちません。' },
            { card: 'kp3-5', d: 1, why: '「お水をもう少しいただけますか?」— 辛さ対策としては正しいですが、先に苦手だと伝えておくほうが親切です。' },
            { card: 'kp3-3', d: 0, why: '「本当においしいですね」— まだ食べていません。このあと大盛りにされてしまいます。' },
            { card: 'kp3-8', d: -1, why: '「次は私がおごりますね」— 鍋を勧められている最中に会計の話。噛み合っていません。' }
          ] },
        { s: '食事も終わり、先生が伝票を持って立ち上がった。止めても引かない気配だ。',
          line: { t: '오늘은 제가 살게요. 멀리서 오셨는데요.', ja: '今日は私が出しますよ。遠くからいらしたんですから。' },
          choices: [
            { card: 'kp3-8', d: 3, best: true, why: '「다음엔 제가 살게요」— ここは素直にごちそうになり、次を約束するのがいちばん美しい返し。再会の約束にもなります。' },
            { card: 'kp3-7', d: 2, why: '「私が払います」— 一度は言うのが礼儀です。ただ、目上の方が決めた以上、押し切るのは野暮になります。' },
            { card: 'kp3-3', d: 1, why: '「本当においしいですね」— 感想としては嬉しい一言ですが、いま返すべき言葉は別にあります。' },
            { card: 'kp3-6', d: -1, why: '「もうやめておきます」— お酒を断る言葉です。お会計の場面では意味が通りません。' }
          ] }
      ]
    }
  }
...
const ROUTES = {
  ...
  seoul: {
    key: 'seoul', title: '🌷 Seoul Route', lang: 'ko', list: SEOUL_ROUTE,
    goal: '🛫 帰国の日', clearAch: 'seoul-clear', clearGems: 10, help: false,
    note: '学会には出ず、懇親会と観光でソウルを過ごす1週間。各駅のフレーズを学びきると、その場面の会話に挑めます。学んだフレーズだけが選択肢に現れます。'
  },
  hk: {
