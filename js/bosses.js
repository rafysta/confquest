    ...
    turns: [
      {
        ...
        choices: [
          ...
          { text: 'Yes, no problem. I have given this talk many times.', delta: 0,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Oh... I should apologize to the committee...', delta: 0,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Of course! I will attend everything!', delta: 0,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Please give me an easy first question if nobody raises a hand.', delta: 2,
    ...
    turns: [
      {
        ...
        choices: [
          ...
          { text: 'With respect, those studies were poorly designed.', delta: -2,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'That can\'t be true. Our data is very solid.', delta: -2,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'I\'m sorry if I seemed arrogant.', delta: 1,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Collaborators? Let me think about it and maybe contact you someday.', delta: 1,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Being right, of course. Science is about truth.', delta: 1,
    ...
    turns: [
      {
        ...
        choices: [
          ...
          { text: 'That is... um... a good question. Very good question. Yes.', delta: -1,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'That experiment was done by my collaborator, so I cannot answer.', delta: -2,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'Maybe if the loops... um... do something different?', delta: 0,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'I knew it! Your comments were so unfair!', delta: -3,
      ...
      },
      {
        ...
        choices: [
          ...
          { text: 'I will think about which journal is best for us.', delta: 1,
